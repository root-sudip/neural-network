...
class MLP:
    ...
    def MLP_computation(self,d1):
        ...
        with self.mygraph.as_default():
            ...
            true=tf.arg_max(self.y, 1) # y[0,0,1] then true is 3
            predicted=tf.arg_max(self.layer3_out, 1) # layer3_out[0.2, 0.3,0.5] then predicted will be 3
...
obj.fit(X_Train,Y_Train,300,32)
